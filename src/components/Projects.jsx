  ...
  return (
    <>
      <div className="flex flex-col items-start w-full min-h-screen bg-[#F9EEE8] dark:bg-[#31302D]">
        <div className="flex flex-col gap-4 px-8 py-4 xl:gap-8 md:px-24 md:py-8 lg:px-36 lg:py-12 xl:px-72 2xl:px-80 xl:py-16 2xl:py-20">
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4 px-8 pb-4 md:px-24 lg:px-36 xl:px-72 2xl:px-80">
