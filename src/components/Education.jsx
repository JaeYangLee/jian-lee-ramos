  ...
  return (
    <>
      <div className="flex flex-col items-start w-full min-h-screen bg-[#F9EEE8] dark:bg-[#31302D] dark:text-[#F9EEE8] ">
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4 px-8 py-4 lg:items-start lg:justify-start 2xl:items-center 2xl:justify-center lg:gap-12 md:gap-12 md:flex-row md:px-24 lg:px-36 xl:px-72 2xl:px-80">
          <div className="">
            <img
