    ...
    <>
      <div className="flex flex-col items-start w-full min-h-screen bg-[#F9EEE8]">
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4 px-8 py-4 lg:items-start lg:justify-start lg:gap-12 md:gap-12 md:flex-row md:px-24 lg:px-36 xl:px-72">
          <div className="">
            <img
              className="size-64 lg:size-94 xl:size-106 object-cover rounded-lg shadow-[#31302D] shadow-lg"
          ...
          <div className="flex flex-col items-center justify-center gap-2 lg:gap-4 md:items-start md:justify-start">
            ...
            <p className="font-mono text-sm font-light text-center xl:text-lg text-[#31302D] opacity-60">
              S.Y. 2021-2025
            </p>
            <p className="font-mono text-sm font-light text-center xl:text-lg text-[#31302D] opacity-60">
              STI College San Jose Del Monte
            </p>
            <p className="pb-4 font-mono text-sm font-light text-center xl:text-lg text-[#31302D] opacity-60">
              Bulacan, Philippines
            </p>
            <hr className="w-full opacity-30" />
          </div>
