            ...
            <li
              ...
              className={
                activeSection === "projects"
                  ? "p-2 2xl:p-4 rounded-t  bg-[#F9EEE8] dark:bg-[#31302D] dark:text-[#F9EEE8] text-[#31302D] md:text-lg lg:text-2xl xl:text-3xl shadow-[8px_8px_0px_0px] shadow-black transition-all origin-bottom duration-200 ease-out select-none"
